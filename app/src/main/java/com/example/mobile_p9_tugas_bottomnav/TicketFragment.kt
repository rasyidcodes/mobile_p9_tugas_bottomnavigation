...
import com.example.mobile_p9_tugas_bottomnav.databinding.FragmentTicketBinding
...
class TicketFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val action = TicketFragmentDirections.actionTicketFragment2ToOrderTicketFragment()
